...
class Motor:
    def __init__(self, name, ForwardPin, ReversePin):
        self.name = name
...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            left_speed = max(-1.0, min(1.0, -left_axis))
            right_speed = max(-1.0, min(1.0, -right_axis))
            ...
            if should_update:
                ...
                print(f"left_speed={left_speed:.2f} right_speed={right_speed:.2f}")
